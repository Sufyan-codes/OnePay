...
export default function CTA() {
  return (
    <section className='bg-[#FFF9EC] pt-1 rounded-lg'>
          <div className='max-w-6xl mx-auto grid grid-col lg:grid-cols-2 items-center px-4 gap-2 mt-28'>
              <div>
                  <h1 className='text-2xl lg:text-6xl tracking-tighter font-semibold'>
                      Start Your <br />
                      Flawless <br />
                      Payment Journey <br />
                      Today
